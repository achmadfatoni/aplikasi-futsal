        ...
        <div class="col-md-8 col-md-offset-2">
            <form class="form-horizontal" method="POST" action="{{ $action }}" id="formPassword">
                ...
                <div class="form-group">
                    <label for="passwordLama" class="col-md-3 col-md-3 col-sm-3 control-label">Password Lama</label>
                ...
                <!-- Input Password Baru -->
                <div class="form-group">
                    <label for="passworBaru" class="col-md-3 col-md-3 col-sm-3 control-label">Password Baru</label>
                ...
                <div class="form-group">
                    <label for="konfirmasiPassword" class="col-md-3 col-md-3 col-sm-3 control-label">Konfirmasi
                        Password</label>
                    <div class="col-md-9 col-md-9 col-sm-9">
                ...
                <!-- Submit -->
                <div class="form-group">
                    <div class="col-md-9 col-md-9 col-sm-9 col-md-offset-3 col-md-offset-3
                    col-sm-offset-3">
